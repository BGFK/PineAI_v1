export const colors = {
  pine: {
    'Pine Green': '#204B44',
    'Pine Main Background': '#FFFFFF',
    'Pine Main Text': '#111827', // This is now equivalent to text-gray-900 in Tailwind CSS
    'Pine Sidebar Background': '#F9FAFB', // This is the hex code for bg-gray-50 in Tailwind CSS
